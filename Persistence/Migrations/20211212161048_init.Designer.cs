...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelAutomation.Domain.Models.Rooms.Room", b =>
                {
            ...
            modelBuilder.Entity("HotelAutomation.Domain.Models.Rooms.RoomGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HotelAutomation.Domain.Models.Rooms.Room", b =>
                {
                    b.HasOne("HotelAutomation.Domain.Models.Rooms.RoomGroup", "RoomGroup")
                        .WithMany()
                        .HasForeignKey("RoomGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("HotelAutomation.Domain.Models.ValueObjects.Price", "PricePerNight", b1 =>
                        {
            ...
            modelBuilder.Entity("HotelAutomation.Domain.Models.Rooms.RoomGroup", b =>
                {
                    b.OwnsOne("HotelAutomation.Domain.Models.ValueObjects.Price", "MinPrice", b1 =>
                        {
            ...
            modelBuilder.Entity("HotelAutomationApp.Domain.Models.Rooms.RoomImage", b =>
                {
                    b.HasOne("HotelAutomation.Domain.Models.Rooms.Room", "Room")
                        .WithMany("Images")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
